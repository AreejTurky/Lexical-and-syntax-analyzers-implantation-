...
public class NFA {
	...
	private String re;
	private String re_Joined;
	private String re_Postfix;
	...
	public String postfix() {
		...
		String out_string = "";
		int read_location = 0;
		ch = re_Joined.charAt(read_location++);
		while (!s.empty()) {
			if (is_letter(ch)) {
	...
	public void re2nfa() {
		...
		char ch[] = re_Postfix.toCharArray();
	...
	public void print() {
		...
		System.out.println("final state: " + (this.pair.endNode.getState()));
             System.out.println("--------RE--TO--NFA--------");
             System.out.println();
	}
